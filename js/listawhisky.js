document.addEventListener('DOMContentLoaded', function () {
    fetch('https://cacgrupo5.pythonanywhere.com/productos')
        ...
        .then(data => {
            ...
            const productosWhisky = productos.filter(producto => producto.categoria.toLowerCase() === 'whisky');
            let html = '';

            productosWhisky.forEach(producto => {
                html += `<div class="col-md-4 mb-4">
                            <div class="card" style="width: 18rem;">
                                <img src="../assets/whisky2.png" class="card-img-top" alt="whisky">
                                <div class="card-body">
